...
const FilterModal = ({ open, handleClose, textSearchTypeFilter, marketplaceFilter, priorityFilter, setTextSearchTypeFilter, setPriorityFilter, setMarketplaceFilter }) => {
